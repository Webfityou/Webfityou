...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  // Contrôler le scroll du body quand le menu est ouvert
  useEffect(() => {
    if (isMenuOpen) {
    ...
    // Cleanup function pour remettre le scroll normal
    return () => {
      document.body.style.overflow = 'unset';
    };
  }, [isMenuOpen]);
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          {isMenuOpen && (
            <>
              ...
              <motion.div
                ...
                className="lg:hidden fixed top-0 right-0 h-full w-80 bg-white z-50 shadow-2xl flex flex-col border-l border-gray-200 overflow-hidden"
              >
                {/* Header */}
      ...
      <div className="fixed bottom-6 right-6 z-40">
          ...
          {isWhatsAppOpen && (
            ...
            >
              ...
              <motion.a
                ...
                className="group flex items-center bg-green-500 text-white px-4 py-3 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:shadow-xl whitespace-nowrap"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center bg-blue-500 text-white px-4 py-3 rounded-full shadow-lg hover:bg-blue-600 transition-all duration-300 hover:shadow-xl whitespace-nowrap"
                whileHover={{ scale: 1.05, x: -5 }}
                whileTap={{ scale: 0.95 }}
              >
        ...
        <motion.button
          ...
          className="w-14 h-14 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:shadow-xl flex items-center justify-center"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><Link to="/a-propos" className="hover:text-gray-900 transition-colors">{t('nav.about')}</Link></li>
                <li><Link to="/blog" className="hover:text-gray-900 transition-colors">{t('nav.blog')}</Link></li>
                <li><Link to="/contact" className="hover:text-gray-900 transition-colors">{t('nav.contact')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>webfityou@gmail.com</li>
                <li>+33 6 38 22 98 04</li>
                <li>Paris, France</li>
              </ul>
            </div>
          </div>
          ...
          {/* Social Media Links */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-8 pt-8 border-t border-gray-800">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8 3a5 5 0 0 0-5 5v8a5 5 0 0 0 5 5h8a5 5 0 0 0 5-5V8a5 5 0 0 0-5-5H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z"/>
              </svg>
            </a>
          </div>
